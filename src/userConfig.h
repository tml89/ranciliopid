...
// Display
#define OLED_DISPLAY 0             // 0 = deactivated, 1 = SH1106 (e.g. 1.3 "128x64), 2 = SSD1306 (e.g. 0.96" 128x64)
...
const unsigned int dndStartH = 23;
...
#define BREWSWITCHTYPE 2           // 1 = normal Switch, 2 = Trigger Switch
...
#define MQTT_SERVER_IP "192.168.178.9"   // IP-Address of locally installed mqtt server
